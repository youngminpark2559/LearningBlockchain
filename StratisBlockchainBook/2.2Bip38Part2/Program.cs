...
namespace _2._2Bip38
{
    class Program
    {
        static void Main()
        {
            ...
            //And then, I give this PassphraseCode to a third party key generator. And then, the third party will generate new encrypted keys for me.
            EncryptedKeyResult encryptedKeyResult = passphraseCode.GenerateEncryptedSecret();

            //encryptedKeyResult has several informations.
            //This is the generated bitcoin address.
            var generatedAddress = encryptedKeyResult.GeneratedAddress;
            //This is the encryptedKey inself.
            ...
            //BIP 32, or Hierarchical Deterministic Wallet(HD wallets) proposes another solution, which is more widely supported.
        }
    }
}
