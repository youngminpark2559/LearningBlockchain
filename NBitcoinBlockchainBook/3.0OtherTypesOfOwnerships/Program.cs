...
namespace _3._0OtherTypesOfOwnerships
{
    class Program
    {
        static void Main()
        {
            ...
            //The Blockchain identifies a receiver by a ScriptPubKey. And such ScriptPubKey could be generated from a Bitcoin address.
        ...
        //It's because unsigned transaction has already been signed by Alice private key from above.
           ...
           Script redeemScriptPubKeyForP2shPayment =
            ...
            //This can be spent in either case you know the data(birthDate) that can generate birthDateHash, or you own the private key related to the Bitcoin address of this book.
            ...
            //The first option for some spender to spend the coin is to know my birth date to prove the ownership for the coin by interacting with the scriptSig.
            ...
            //You can see that in the scriptSig I push OP_1 so I enter into the OP_IF of my redeemScriptForSendingCoinToBook.
            ...
            //The second way for some spender to spend the coin is by proving ownership of the Bitcoin address, 1KF8kUVHK42XzgcmJF4Lxz4wcL5WDL97PB, by the corresponding private key.
